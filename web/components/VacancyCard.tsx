...
export function VacancyCard({
  ...
  /** Готовое превью описания: считается на сервере (lib/vacancy-preview.ts),
      чтобы полные тексты вакансий не сериализовались в RSC-payload. */
  ...
  return (
    ...
    >
      ...
      {descriptionPreview ? (
        <p className="job-desc" title={descriptionPreview}>
          {descriptionPreview}
        </p>
      ) : null}
