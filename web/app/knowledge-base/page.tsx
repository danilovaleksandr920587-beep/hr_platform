...
export const metadata: Metadata = {
  title: "База знаний — Гайды для начинающих специалистов",
  description:
    "Практические гайды для студентов и выпускников: резюме, собеседования, тестовые задания, зарплата, отклики и карьерный рост.",
